    ...
    with aba_gerador:
        ...
        if df_convenios.empty:
            ...
            instrucao = col1.selectbox("Código de Instrução:", [
                "01 - Remessa", "02 - Pedido de Baixa", "04 - Concessão de Abatimento",
                "05 - Cancelamento de Abatimento", "06 - Alteração de Vencimento",
                "09 - Protestar", "10 - Não Protestar"
            ])
    ...
    with aba_clientes:
        ...
        if not df_clientes.empty:
            ...
            with aba_excluir_lote:
                ...
                # Controle de estado para o botão "Marcar Todos"
                ...
                with container_lista:
                    for cliente_texto in opcoes_clientes:
                        # Inicializa o estado individual se não existir
